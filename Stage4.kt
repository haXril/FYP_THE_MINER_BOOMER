...
class Stage4 : AppCompatActivity() {
    ...
    private var randomNumber = (1..16).random()
    private var randomNumber1 = (1..16).random()
    private var randomNumber2 = (1..16).random()
    private var randomNumber3 = (1..16).random()
    private var randomNumber4 = (1..16).random()
    ...
    private fun note1(message: String?, playerId: String?, playerName: String?, playerAge: String?, playerEmail: String?, playerPassword: String?, playerImageId:Int?, gameLevel: String?){
        ...
        y.setOnClickListener{
            Intent(this@Stage4, MedGame4::class.java).also {
