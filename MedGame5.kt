...
class MedGame5 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_med_game5)
        ...
        val em = HistoryPlayer(playerName, gameLevel, 5)
                ...
                if(gotList.size == noBoomCubeList.size){
                    ...
                    dbRf.child(userId).setValue(em)
                        .addOnCompleteListener{
                            ...
                            startActivity(Intent(this@MedGame5, MainActivity2::class.java).also {
