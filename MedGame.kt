...
class MedGame : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (gameLevel == "EASY"){
                    ...
                    if(gotList.size == noBoomCubeList.size){
                        ...
                        dbRf.child(userId).setValue(em)
                            .addOnCompleteListener{
                                ...
                                startActivity(Intent(this@MedGame, Stage2::class.java).also {
            ...
            if (!(got1 == 3 || got2 == 3 || got3 == 3)){
                ...
                c3.setOnClickListener {
                    c3.background.setTint(Color.WHITE)
                    gotList.add(1)
                    if(gotList.size == noBoomCubeList.size){
                        timer.cancel()
            ...
            if (!(got1 == 6 || got2 == 6 || got3 == 6)){
                ...
                c6.setOnClickListener {
                    c6.background.setTint(Color.WHITE)
                    gotList.add(1)
                    if(gotList.size == noBoomCubeList.size){
                        timer.cancel()
            ...
            if (!(got1 == 14 || got2 == 14 || got3 == 14)){
                ...
                c14.setOnClickListener {
                    c14.background.setTint(Color.WHITE)
                    gotList.add(1)
                    if(gotList.size == noBoomCubeList.size){
                        timer.cancel()
        ...
        if (gameLevel == "HARD"){
            ...
            if (!(got1 == 15 || got2 == 15 || got3 == 15 || got4 == 15 || got5 == 15 || got6 == 15 || got7 == 15 || got8 == 15 || got9 == 15 || got10 == 15)){
                noBoomCubeList.add(1)
                c15.setOnClickListener {
                    c15.background.setTint(Color.WHITE)
                    gotList.add(1)
            ...
            if (!(got1 == 16 || got2 == 16 || got3 == 16 || got4 == 16 || got5 == 16 || got6 == 16 || got7 == 16 || got8 == 16 || got9 == 16 || got10 == 16)){
                noBoomCubeList.add(1)
                c16.setOnClickListener {
                    c16.background.setTint(Color.WHITE)
                    gotList.add(1)
            ...
            if (!(got1 == 17 || got2 == 17 || got3 == 17 || got4 == 17 || got5 == 17 || got6 == 17 || got7 == 17 || got8 == 17 || got9 == 17 || got10 == 17)){
                noBoomCubeList.add(1)
                c17.setOnClickListener {
                    c17.background.setTint(Color.WHITE)
                    gotList.add(1)
            ...
            if (!(got1 == 18 || got2 == 18 || got3 == 18 || got4 == 18 || got5 == 18 || got6 == 18 || got7 == 18 || got8 == 18 || got9 == 18 || got10 == 18)){
                noBoomCubeList.add(1)
                c18.setOnClickListener {
                    c18.background.setTint(Color.WHITE)
                    gotList.add(1)
            ...
            if (!(got1 == 19 || got2 == 19 || got3 == 19 || got4 == 19 || got5 == 19 || got6 == 19 || got7 == 19 || got8 == 19 || got9 == 19 || got10 == 19)){
                noBoomCubeList.add(1)
                c19.setOnClickListener {
                    c19.background.setTint(Color.WHITE)
                    gotList.add(1)
            ...
            if (!(got1 == 20 || got2 == 20 || got3 == 20 || got4 == 20 || got5 == 20 || got6 == 20 || got7 == 20 || got8 == 20 || got9 == 20 || got10 == 20)){
                noBoomCubeList.add(1)
                c20.setOnClickListener {
                    c20.background.setTint(Color.WHITE)
                    gotList.add(1)
        ...
        if (gameLevel == "MEDIUM"){
            ...
            if (!(got1 == 16 || got2 == 16 || got3 == 16 || got4 == 16 || got5 == 16)){
                noBoomCubeList.add(1)
                c16.setOnClickListener {
                    c16.background.setTint(Color.WHITE)
                    gotList.add(1)
            ...
            if (!(got1 == 17 || got2 == 17 || got3 == 17 || got4 == 17 || got5 == 17)){
                noBoomCubeList.add(1)
                c17.setOnClickListener {
                    c17.background.setTint(Color.WHITE)
                    gotList.add(1)
            ...
            if (!(got1 == 18 || got2 == 18 || got3 == 18 || got4 == 18 || got5 == 18)){
                noBoomCubeList.add(1)
                c18.setOnClickListener {
                    c18.background.setTint(Color.WHITE)
                    gotList.add(1)
            ...
            if (!(got1 == 19 || got2 == 19 || got3 == 19 || got4 == 19 || got5 == 19)){
                noBoomCubeList.add(1)
                c19.setOnClickListener {
                    c19.background.setTint(Color.WHITE)
                    gotList.add(1)
            ...
            if (!(got1 == 20 || got2 == 20 || got3 == 20 || got4 == 20 || got5 == 20)){
                noBoomCubeList.add(1)
                c20.setOnClickListener {
                    c20.background.setTint(Color.WHITE)
                    gotList.add(1)
        ...
        n.setOnClickListener{
            ...
            dbRf.child(userId).setValue(em)
                .addOnCompleteListener{
                    ...
                    startActivity(Intent(this@MedGame, MainActivity2::class.java).also {
                        it.putExtra("username", playerName)
                        it.putExtra("age", playerAge)
                        it.putExtra("id", playerId)
                        it.putExtra("imageId", playerImageId)
