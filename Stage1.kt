...
class Stage1 : AppCompatActivity() {
    ...
    private lateinit var c14: CardView
    ...
    private lateinit var r3: ImageView
    private lateinit var r4: ImageView
    private lateinit var r5: ImageView
    private lateinit var r6: ImageView
    ...
    private lateinit var r14: ImageView
    ...
    private var randomNumber1 = (1..20).random()
    private var randomNumber2 = (1..20).random()
    private var randomNumber3 = (1..20).random()
    private var randomNumber4 = (1..20).random()
    private var randomNumber5 = (1..20).random()
    private var randomNumber6 = (1..20).random()
    private var randomNumber7 = (1..20).random()
    private var randomNumber8 = (1..20).random()
    private var randomNumber9 = (1..20).random()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        c3 = findViewById(R.id.cube3)
        c4 = findViewById(R.id.cube4)
        c5 = findViewById(R.id.cube5)
        c6 = findViewById(R.id.cube6)
        ...
        r3 = findViewById(R.id.boom3)
        r4 = findViewById(R.id.boom4)
        r5 = findViewById(R.id.boom5)
        r6 = findViewById(R.id.boom6)
        ...
        if (gameLevel == "EASY"){
            ...
            if((randomNumber == 15) || (randomNumber1 == 15) || (randomNumber2 == 15)){
                c15.isVisible = false
                r15.isVisible = true
            }
            if((randomNumber == 16) || (randomNumber1 == 16) || (randomNumber2 == 16)){
                c16.isVisible = false
                r16.isVisible = true
            }
            if((randomNumber == 17) || (randomNumber1 == 17) || (randomNumber2 == 17)){
                c17.isVisible = false
                r17.isVisible = true
            }
            if((randomNumber == 18) || (randomNumber1 == 18) || (randomNumber2 == 18)){
                c18.isVisible = false
                r18.isVisible = true
            }
            if((randomNumber == 19) || (randomNumber1 == 19) || (randomNumber2 == 19)){
                c19.isVisible = false
                r19.isVisible = true
            }
            if((randomNumber == 20) || (randomNumber1 == 20) || (randomNumber2 == 20)){
                c20.isVisible = false
                r20.isVisible = true
            }
        }
        if (gameLevel == "MEDIUM"){
            ...
            if((randomNumber == 16) || (randomNumber1 == 16) || (randomNumber2 == 16) || (randomNumber3 == 16) || (randomNumber4 == 16)){
                c16.isVisible = false
                r16.isVisible = true
            }
            if((randomNumber == 17) || (randomNumber1 == 17) || (randomNumber2 == 17) || (randomNumber3 == 17) || (randomNumber4 == 17)){
                c17.isVisible = false
                r17.isVisible = true
            }
            if((randomNumber == 18) || (randomNumber1 == 18) || (randomNumber2 == 18) || (randomNumber3 == 18) || (randomNumber4 == 18)){
                c18.isVisible = false
                r18.isVisible = true
            }
            if((randomNumber == 19) || (randomNumber1 == 19) || (randomNumber2 == 19) || (randomNumber3 == 19) || (randomNumber4 == 19)){
                c19.isVisible = false
                r19.isVisible = true
            }
            if((randomNumber == 20) || (randomNumber1 == 20) || (randomNumber2 == 20) || (randomNumber3 == 20) || (randomNumber4 == 20)){
                c20.isVisible = false
                r20.isVisible = true
            }
        }
        if (gameLevel == "HARD"){
            ...
            if((randomNumber == 15) || (randomNumber1 == 15) || (randomNumber2 == 15) || (randomNumber3 == 15) || (randomNumber4 == 15) || (randomNumber5 == 15) || (randomNumber6 == 15) || (randomNumber7 == 15) || (randomNumber8 == 15) || (randomNumber9 == 15)){
                c15.isVisible = false
                r15.isVisible = true
            }
            if((randomNumber == 16) || (randomNumber1 == 16) || (randomNumber2 == 16) || (randomNumber3 == 16) || (randomNumber4 == 16) || (randomNumber5 == 16) || (randomNumber6 == 16) || (randomNumber7 == 16) || (randomNumber8 == 16) || (randomNumber9 == 16)){
                c16.isVisible = false
                r16.isVisible = true
            }
            if((randomNumber == 17) || (randomNumber1 == 17) || (randomNumber2 == 17) || (randomNumber3 == 17) || (randomNumber4 == 17) || (randomNumber5 == 17) || (randomNumber6 == 17) || (randomNumber7 == 17) || (randomNumber8 == 17) || (randomNumber9 == 17)){
                c17.isVisible = false
                r17.isVisible = true
            }
            if((randomNumber == 18) || (randomNumber1 == 18) || (randomNumber2 == 18) || (randomNumber3 == 18) || (randomNumber4 == 18) || (randomNumber5 == 18) || (randomNumber6 == 18) || (randomNumber7 == 18) || (randomNumber8 == 18) || (randomNumber9 == 18)){
                c18.isVisible = false
                r18.isVisible = true
            }
            if((randomNumber == 19) || (randomNumber1 == 19) || (randomNumber2 == 19) || (randomNumber3 == 19) || (randomNumber4 == 19) || (randomNumber5 == 19) || (randomNumber6 == 19) || (randomNumber7 == 19) || (randomNumber8 == 19) || (randomNumber9 == 19)){
                c19.isVisible = false
                r19.isVisible = true
            }
            if((randomNumber == 20) || (randomNumber1 == 20) || (randomNumber2 == 20) || (randomNumber3 == 20) || (randomNumber4 == 20) || (randomNumber5 == 20) || (randomNumber6 == 20) || (randomNumber7 == 20) || (randomNumber8 == 20) || (randomNumber9 == 20)){
                c20.isVisible = false
                r20.isVisible = true
            }
        }
    ...
    private fun note1(ms: String?, playerId: String?, playerName: String?, playerAge: String?, playerImageId:Int?, gameLevel: String?){
        ...
        val em = HistoryPlayer(playerName, gameLevel, 0)
        ...
        n.setOnClickListener{
            ...
            dbRf.child(userId).setValue(em)
                .addOnCompleteListener{
                    ...
                    startActivity(Intent(this@Stage1, MainActivity2::class.java).also {
            ...
            val dataUpdate = User(playerId, playerName, playerAge, playerImageId, 0)
        ...
        y.setOnClickListener{
            if (gameLevel == "EASY"){
                Intent(this@Stage1, MedGame::class.java).also {
