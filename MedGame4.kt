...
class MedGame4 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_med_game4)
        ...
        val em = HistoryPlayer(playerName, gameLevel, 4)
                ...
                if(gotList.size == noBoomCubeList.size){
                    ...
                    dbRf.child(userId).setValue(em)
                        .addOnCompleteListener{
                            ...
                            startActivity(Intent(this@MedGame4, Stage5::class.java).also {
            ...
            c2.setOnClickListener {
                ...
                if(gotList.size == noBoomCubeList.size){
                    ...
                    dbRf.child(userId).setValue(em)
                        .addOnCompleteListener{
                            Toast.makeText(this, "Nice!!", Toast.LENGTH_LONG).show()
                            startActivity(Intent(this@MedGame4, MainActivity2::class.java).also {
                                it.putExtra("email", playerEmail)
                                it.putExtra("username", playerName)
                                it.putExtra("age", playerAge)
                                it.putExtra("password", playerPassword)
    ...
    private fun note1(ms: String?, playerId: String?, playerName: String?, playerAge: String?, playerEmail: String?, playerPassword: String?, playerImageId:Int?, gameLevel: String?){
